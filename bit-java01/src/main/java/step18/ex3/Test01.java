 ...
 *      Tesla에서 모두 만들어야 한다.
 *    - 아 피곤하다. 
 *      ElectCar의 상속을 포기하는 댓가로 
 *      ElectCar의 모든 기능을 Tesla에서 재작성해야 한다.
...
public class Test01 {
  ...
  public static void main(String[] args) {
     ...
     * Tesla 클래스가 ElectMotor 클래스의 상속을 포기하고
     * Car 클래스의 자식 클래스로 만들었다는 점이다.
     * 만약 ElectMotor 클래스에 기능이 무진장 많이 있었다면,
