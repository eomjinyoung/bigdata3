...
public class Category {
  ...
  public static final int LIFE_FRIDGE = 4001;
  public static final int LIFE_TV = 4002;
  public static final int FURNITURE_CABINET = 5001;
  public static final int FURNITURE_CHAIR = 5002;
}
